      ...
      <div className="audiencesContainer">
        <div className="audiencesTopWrap">
            ...
            <div className="audienceBtnWrap">
                <button className="audienceBtn audienceBtnActive" id="a1" onClick={event => handleClick(event)}>Government</button>
                <button className="audienceBtn" id="a2" onClick={event => handleClick(event)}>Policy Makers</button>
                <button className="audienceBtn" id="a3" onClick={event => handleClick(event)}>Healthcare Plans & Providers</button>
                <button className="audienceBtn" id="a4" onClick={event => handleClick(event)}>Philanthropy</button>
                <button className="audienceBtn" id="a5" onClick={event => handleClick(event)}>Academia</button>
                <button className="audienceBtn" id="a6" onClick={event => handleClick(event)}>Residents</button>
                <button className="audienceBtn" id="a7" onClick={event => handleClick(event)}>Media</button>
                <button className="audienceBtn" id="a8" onClick={event => handleClick(event)}>Researchers</button>
                <button className="audienceBtn" id="a9" onClick={event => handleClick(event)}>Prospective Employees</button>
            </div>
        </div>
        <div className="audiencesBtmWrap">
            <div className="audienceContent aHide aShow" id="aContenta1">
                <div className="aContentLeft">
                    <img src={capitolBldng} alt="A capitol building with a car in the foreground" className='audienceImg'/>
                </div>
                <div className="aContentRight">
                    <h4>Government</h4>
                    <p className="pDark">We work togther with federal, state and local government agencies to identify eligible individuals 
                    in need of services, and develop critical strategies and reforms to streamline the benefits access landscape.</p>
                    <div className="articleLinkWrap">
                        <a href="/" className="mainLink is--topPadSmall">Our state partners</a>
                        <img src={rightArrow} alt="right arrow icon" className='linkArrow'/>
                    </div>
                    <div className="articleLinkWrap">
                        <a href="/" className="mainLink is--topPadSmall">Policy-related resources</a>
                        <img src={rightArrow} alt="right arrow icon" className='linkArrow'/>
                    </div>
                    <div className="articleLinkWrap">
                        <a href="/" className="mainLink is--topPadSmall">Contact us</a>
                        <img src={rightArrow} alt="right arrow icon" className='linkArrow'/>
                    </div>
                </div>
            </div>

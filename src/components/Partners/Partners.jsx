    ...
    <section>
        <div className="container partnerContainer">
            <div className="partnersContent">
                <h2>Our Partners</h2>
                <p className="pDark is--topPad">Together with a national network of partners, we work to influence change and build solutions 
                to provide more dignified, equitable, and efficient benefits access.</p>

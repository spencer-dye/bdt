        ...
        <div className='container is--divider'>
            <div className="insightsHeader">
                <div>
                    ...
                    <p className="pDark is--topPadSmall">Check out what we've been working on recently</p>
                </div>
                <button className="altBtn">View all
                    <img src={rightArrow} alt="an arrow pointing right" className='linkArrow'/>
                </button>
            </div>

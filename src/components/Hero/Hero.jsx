        ...
        <section className="heroColor">
            <div className="container heroContainer">
                ...
                <div className="heroTextWrap">
                    ...
                    <p className="pLight is--contentTop">Each year, $60 billion in food, healthcare, and other assistance goes 
                    untapped—we are committed to closing that gap to reduce hunger and poverty and build pathways to economic mobility.</p>
